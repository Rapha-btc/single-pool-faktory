...
The simulation below deploys and tests the flat-single-faktory-stxer contract which
...
const BOB_PROVIDER = "SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH"; // "SP38GBVK5HEJ0MBH4CRJ9HQEW86HX0H9AP1HZ3SVZ";
...
SimulationBuilder.new()
  ...
  // Deploy the flat-single-faktory-stxer contract (which references the real contracts)
  .addContractDeploy({
    contract_name: "flat-single-faktory-stxer",
    source_code: fs.readFileSync(
      "./contracts/flat-single-faktory-stxer.clar",
      "utf8"
    ),
  ...
  .addContractCall({
    contract_id: `${DEPLOYER}.flat-single-faktory-stxer`,
    function_name: "initialize-pool",
    function_args: [uintCV(50000000000000)], // Your exact amount (BOB tokens)
  })

  // Check pool info after initialization
  .addEvalCode(`${DEPLOYER}.flat-single-faktory-stxer`, "(get-pool-info)")
  ...
  .addEvalCode(
    `${DEPLOYER}.flat-single-faktory-stxer`,
...
// all green: https://stxer.xyz/simulations/mainnet/9f1c6561fc31914a20f18d7c66bd9556
