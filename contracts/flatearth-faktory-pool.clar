;; Title: sBTC-FlatEarth lp-token (Single Pool)
      ;; Version: 1.0.0
      ...
      (define-public (swap-a-to-b (amount uint) (min-y-out uint))
          (let (
              ...
              (try! (as-contract (contract-call? .flat-earth-stxcity transfer dy-d CONTRACT sender none)))
              (print {
                  type: "buy",
                  sender: sender,
                  token-in: .sbtc-token,
                  amount-in: amount,
                  token-out: .flat-earth-stxcity,
                  amount-out: dy-d,
      ...
      (define-public (add-liquidity (amount uint))
          (let (
              ...
              (try! (contract-call? .flat-earth-stxcity transfer dy-d sender CONTRACT none))
      ...
      (define-private (get-reserves)
          { 
            ...
            b: (unwrap-panic (contract-call? .flat-earth-stxcity get-balance CONTRACT))
          })
    ...
    ;;     (try! (contract-call?
    ;;       .flat-earth-stxcity
    ;;       transfer u144198362107 tx-sender CONTRACT none
    ;;     ))
    ;;     (print {
