...
;; Title: sBTC-B lp-token
    ...
    ;;   (impl-trait 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.dexterity-traits-v0.liquidity-pool-trait)
      ...
      ;; (define-constant CONTRACT_INITIALIZER .b-faktory-dex)
      (define-constant SAINT 'SP000000000000000000002Q6VF78)
  
      ;; Define LP token
      (define-fungible-token sBTC-B)
      ...
      (define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
          (begin
              ...
              (try! (ft-transfer? sBTC-B amount sender recipient))
      ...
      (define-read-only (get-balance (who principal))
          (ok (ft-get-balance sBTC-B who)))
  
      (define-read-only (get-total-supply)
          (ok (ft-get-supply sBTC-B)))
      ...
      (define-public (swap-a-to-b (amount uint) (min-y-out uint))
          (let (
              ...
              (try! (as-contract (contract-call? .b-faktory transfer dy-d CONTRACT sender none)))
              (print {
                  type: "buy",
                  sender: sender,
                  token-in: .sbtc-token,
      ...
      (define-public (swap-b-to-a (amount uint) (min-y-out uint))
          (let (
              ...
              (try! (contract-call? .b-faktory transfer amount sender CONTRACT none))
      ...
      (define-public (add-liquidity (amount uint))
          (let (
              ...
              (try! (contract-call? .b-faktory transfer dy-d sender CONTRACT none))
              (try! (ft-mint? sBTC-B dk-d sender))
              (print {
                  type: "add-liquidity",
                  sender: sender,
                  token-a: .sbtc-token,
      ...
      (define-public (remove-liquidity (amount uint))
          (let (
              ...
              (dy-d (get dy delta))
              (dk-d (get dk delta)))
              (try! (ft-burn? sBTC-B dk-d sender))
      ...
      (define-private (get-reserves)
          { 
            ...
            b: (unwrap-panic (contract-call? .b-faktory get-balance CONTRACT))
          })
    ...
    ;;        (try! (contract-call? .b-faktory transfer highest contract-caller CONTRACT none))
    ;;        (print {
