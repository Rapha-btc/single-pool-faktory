;; 'SP2VG7S0R4Z8PYNYCAQ04HCBX1MH75VT11VXCWQ6G.b-faktory
...
(define-public (deposit-sbtc-for-lp (lp-amount uint))
    (let (
          ...
          (lp-result (try! (as-contract (contract-call? .b-faktory-pool 
...
(define-public (withdraw-lp-tokens)
  (let ((unlock-block (+ (var-get creation-block) LOCK_PERIOD))
    ...
    (let ((remove-result (try! (as-contract (contract-call? .b-faktory-pool 
        ...
        (try! (as-contract (contract-call? .b-faktory 
