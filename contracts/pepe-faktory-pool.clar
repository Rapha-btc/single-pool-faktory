...
(define-public (swap-a-to-b
  ...
  (let (
      ...
      token-in: .sbtc-token,
      amount-in: amount,
      token-out: .tokensoft-token-v4k68639zxz,
      amount-out: dy-d,
...
(define-public (swap-b-to-a (amount uint))
  (let (
    ...
    (print {
      type: "sell",
      sender: sender,
      token-in: .tokensoft-token-v4k68639zxz,
      amount-in: amount,
...
(define-public (add-liquidity (amount uint))
  (let (
    ...
    (print {
      ...
      token-a: .sbtc-token,
      token-a-amount: dx-d,
      token-b: .tokensoft-token-v4k68639zxz,
      token-b-amount: dy-d,
      lp-tokens: dk-d,
      pool-reserves: (get-reserves-quote),
      pool-contract: CONTRACT,
...
;;   (try! (add-liquidity u4418143))
;;   ;; Transfer additional token B to achieve desired ratio
;;   (try! (contract-call?
;;     .tokensoft-token-v4k68639zxz
;;     transfer u138552743779 tx-sender CONTRACT none
;;   ))
;;   (print {
