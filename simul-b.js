...
The simulation below deploys and tests the b-single-faktory-stxer contract which
...
const froggy_PROVIDER = "SPWK34YZPVW724K9C8NRZA6VT4YDA2PB5SSD1VYF";
const SBTC_USER_1 = "SP24MM95FEZJY3XWSBGZ5CT8DV04J6NVM5QA4WDXZ";
const SBTC_USER_2 = "SP24MM95FEZJY3XWSBGZ5CT8DV04J6NVM5QA4WDXZ";
...
SimulationBuilder.new()
  ...
  // Deploy the b-single-faktory-stxer contract (which references the real contracts)
  .addContractDeploy({
    contract_name: "b-single-faktory-stxer",
    source_code: fs.readFileSync(
      "./contracts/b-single-faktory-stxer.clar",
      "utf8"
    ),
  ...
  .addContractCall({
    contract_id: `${DEPLOYER}.b-single-faktory-stxer`,
    function_name: "initialize-pool",
    function_args: [uintCV(5000000000000000)], // Your exact amount (froggy tokens)
  })

  // Check pool info after initialization
  .addEvalCode(`${DEPLOYER}.b-single-faktory-stxer`, "(get-pool-info)")
  ...
  .addContractCall({
    contract_id: `${DEPLOYER}.b-single-faktory-stxer`,
    function_name: "deposit-sbtc-for-lp",
    function_args: [uintCV(500000)], // LP amount parameter
  })

  // Check user LP tokens before any withdrawals
  .addEvalCode(
    `${DEPLOYER}.b-single-faktory-stxer`,
...
// all green: Using block height 3361661 hash 0x8135852018d242d1a164c6bde8f6455ef0b832b8cd85f479cb3f4a4af985629f to run simulation.
// Simulation will be available at: https://stxer.xyz/simulations/mainnet/fb6251b1af9e35fff2b482293472a900
