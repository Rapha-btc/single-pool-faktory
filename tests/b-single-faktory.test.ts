...
const contractName = "b-single-faktory";

describe("B Single Faktory Contract Tests", () => {
  beforeEach(() => {
    simnet.setEpoch("3.0");
  ...
  describe("Contract Configuration & Constants", () => {
    it("should return correct contract configuration", () => {
      ...
      expect(result.result).toStrictEqual(
        Cl.tuple({
          ft: Cl.contractPrincipal(simnet.deployer, "b-faktory"),
          pool: Cl.contractPrincipal(simnet.deployer, "b-faktory-pool"),
