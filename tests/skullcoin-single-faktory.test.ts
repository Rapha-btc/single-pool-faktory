...
const contractName = "skullcoin-single-faktory";

describe("Skull Single Faktory Contract Tests", () => {
  beforeEach(() => {
    simnet.setEpoch("3.0");
  ...
  describe("Contract Configuration & Constants", () => {
    it("should return correct contract configuration", () => {
      ...
      expect(result.result).toStrictEqual(
        Cl.tuple({
          ft: Cl.contractPrincipal(simnet.deployer, "skullcoin-stxcity"),
          pool: Cl.contractPrincipal(simnet.deployer, "skullcoin-faktory-pool"),
